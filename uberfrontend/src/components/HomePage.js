      ...
      addbooking(booking).then((res) => {
        if (res.status === 200) {
          if (res.data["message"] === "Operator not available") {
            ...
            setTimeout(
              () => this.setState({ success: "Booking done successfully" }),
              1000
            );
          }
        }
            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="form-group">
                ...
                {this.state.errors.destination !== "" && (
                  <span className="error">{this.state.errors.destination}</span>
                )}
              </div>
              ...
              <div className="form-group">
                  ...
                  {Object.keys(this.state.operatorsList).map(
                    (operator, index) =>
                      this.state.operatorsList[index]["quantity"] >= 1 ? (
                        <option
                          key={index}
                          value={this.state.operatorsList[index]["name"]}
                        >
                ...
                {this.state.errors.operator !== "" && (
                  <span className="error">{this.state.errors.operator}</span>
                )}
              </div>
              <button
                type="submit"
