...
export default class HomePage extends Component {
  ...
  getOperator(event) {
    ...
    getoperator(booking).then((res) => {
      if (res.status === 200) {
        if (
          res.data["message"] === "No operators has seats available" ||
          ...
          if (size < 1) {
            ...
            this.setState({
              ...
              operator: res.data[0]["name"] + "/" + res.data[0]["bustime"],
              errors: {
                source: "",
                destination: "",
                operator: "",
                  ...
                  <div className="form-group">
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        this.handleSourceMarker(e.target.value);
                      }}
                      required
                    >
                    ...
                    {this.state.errors.source !== "" && (
                      <span className="error">{this.state.errors.source}</span>
                    )}
                  </div>
                  ...
                  <div className="form-group">
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        this.handleDestinationMarker(e.target.value);
                      }}
                      required
                    >
                  ...
                  <div className="form-group">
                    ...
                    >
                      {Object.keys(this.state.operatorsList).map(
                        (operator, index) =>
                          this.state.operatorsList[index]["quantity"] >= 1 ? (
                            <option
                              key={index}
                              value={
                                this.state.operatorsList[index]["name"] +
                                "/" +
                                this.state.operatorsList[index]["bustime"]
                              }
                            >
                              {this.state.operatorsList[index]["name"] +
                                " " +
            ...
            <div class="col-xs-6 col-md-6">
              <div className="iframe-container">
                <div>
                  <GoogleMapReact
                    bootstrapURLKeys={{
                      key: "AIzaSyArSiBGE5n217Fcd9N59Y6yIynN6gyVSzM",
                    }}
                    defaultCenter={{
                      lat: 42.361145,
                      lng: -71.057083,
